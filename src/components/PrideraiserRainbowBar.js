    ...
    render() {
        ...
        return (
            <View style={{ flexDirection: "row" }}>
                ...
                <View style={{ backgroundColor: PrideraiserPalette.paleBlue, flex: 1, height: barHeight }} />
                <View style={{ backgroundColor: PrideraiserPalette.white, flex: 1, height: barHeight }} />
                <View style={{ backgroundColor: PrideraiserPalette.palePink, flex: 1, height: barHeight }} />
            </View>
        )
    }
}