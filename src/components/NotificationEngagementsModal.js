...
export default class NotificationEngagementsModal extends React.Component {
    ...
    render() {
        ...
        summary += "First: " + moment(this.state.summary.firstEngagement).format("M/D/YY h:mm:ssa") + "\n"
        summary += "Latest: " + moment(this.state.summary.latestEngagement).format("M/D/YY h:mm:ssa")
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={styles.dataContainer}>
                            <View style={styles.postInfoContainer}>
                                <RegularTextMonospace style={styles.postId} selectable={true}>{this.props.post._id}</RegularTextMonospace>
                                <RegularText style={styles.date} selectable={true}>Published: {moment(this.props.post.publishedAt).format("M/D/YY h:mma")}</RegularText>
                            </View>
                            <RegularText style={styles.summary} selectable={true}>{summary}</RegularText>
                        </View>
                    </View>
                </View>
            </Modal>
