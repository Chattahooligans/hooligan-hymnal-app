    ...
    render(){
        ...
        return(
            <View style={{flex: 1}}> 
                ...
                <Text>Thanks for testing! Stay tuned for updates before the season begins</Text>
                <Text>Please send feedback to Twitter: @chattahooligan or thechattahooligans@gmail.com</Text>
                ...
                <Text>Some code based on open source @nodevember conference schedule app</Text>
            </View>
        )
    }
}
